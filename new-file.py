...
g= datetime.datetime(2024, 3, 10, 00, 00 ,0)
...
\033[1;31m_________________________________________________________""")
print(a16+'▭▬'*30)
...
———————————————''')
    		...
    		print(f"{a40}✦"*60)
    		em = str(input(f"{a4}ايميل اوو ايدي الحساب - id  :"))
    		linex()
    		print(f'{a40}✦'*60)
    		linex()
    		ps = input(f'{a18}كلمة السر - pass  :')
    		linex()
    		e="5990"
    		ee="655"
    		eee="59"
    		...
    		if 'access_token' in po:
    			...
    			linex()
    			print(f"{a40}✦"*60)
    			SDM(f'{a1}[{a3}√{a1}] {a5}اعد تشغيل الاداة✦')
    			linex()
    			...
    			if 'www.facebook.com' in po['error_msg']:
    				...
    				linex()
    				exit(f'{a1}[{a3}×{a1}] {a5}تاكد من الحساب  •')
    	def login_epa2(self):
    		system('clear');
    		print(logo)
    		cooke = input(' cookie : ')
